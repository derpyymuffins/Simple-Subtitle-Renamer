...
def show_credits():
    ...
    ttk.Label(credits_window, text="Twitter:", font=("Arial", 10)).pack(pady=5)
    ttk.Label(credits_window, text="@DashieTweets", foreground="blue", cursor="hand2", font=("Arial", 10)).pack()
    ...
    credits_window.pack_slaves()[3].bind("<Button-1>", lambda e: open_website("https://twitter.com/DashieTweets"))
